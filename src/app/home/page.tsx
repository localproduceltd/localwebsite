...
export default function Home() {
  ...
  // Filter testimonials to show only Jennie, Elfed and Emma (cap at 3)
  const displayedReviews = reviews
    .filter((r) => {
      const name = r.customerName?.toLowerCase() ?? "";
      // Exclude Amanda, keep others
      return !name.includes("amanda");
    })
    .slice(0, 3);
  ...
  return (
    <>
      ...
      {/* Email Signup Strip - moved above CTA */}
